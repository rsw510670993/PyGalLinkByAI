        ...
        for row in rows:
            ...
            try:
                if action == 'check':
                    ...
                    outcome = 'failed' if code in ('error', 'conflict', 'ambiguous', 'shared_cid', 'not_dir', 'no_dn_date', 'missing_in_115') else 'skipped' if code in ('no_link', 'not_downloaded', 'in_offline') else 'success'
